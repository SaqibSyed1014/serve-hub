    ...
    <div class="container">
      <div class="content text-gray-600">
        <div class="content-header text-center">
          <p class="page-subheading">Current as of 20 Jan 2022</p>
          <h1 class="page-heading pt-3 pb-6">
            Privacy Policy
          </h1>
          <p class="text-lg md:text-xl w-full sm:w-3/4 xl:w-2/4 mx-auto">
            Your privacy is important to us at ServeHub. We respect your privacy regarding any information we may collect from you across our website.
          </p>
        </div>
        ...
        <div class="content-body">
          ...
          <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ServeHub, LLC, 7250 Redwood Blvd, Suite 300, Novato, CA 94945.</p>
          </li>
          <li>
          ...
          <li>
          <p><strong>Website</strong> refers to ServeHub, accessible from <a href="https://www.servehub.io" rel="external nofollow noopener" target="_blank">https://www.servehub.io</a></p>
          </li>
          <li>
          ...
          <p>Their Privacy Policy can be viewed at <a href="https://www.apollo.io/privacy-policy" rel="external nofollow noopener" target="_blank">https://www.apollo.io/privacy-policy</a></p>
          </li>
          </ul>
          <h3>Payments</h3>
          ...
          <ul>
          <li>
          <p>By email: hello@servehub.io</p>
          </li>
          <li>
          <p>By visiting this page on our website: <a href="https://www.servehub.io/contact-us" rel="external nofollow noopener" target="_blank">https://www.servehub.io/contact-us</a></p>
          </li>
          </ul>
